...
class Ui_ImportGeoclinoDialog(object):
    def setupUi(self, ImportGeoclinoDialog):
        ...
        self.btnImport.setGeometry(QtCore.QRect(380, 180, 93, 28))
        self.btnImport.setObjectName("btnImport")
        self.btnCancel = QtWidgets.QPushButton(ImportGeoclinoDialog)
        self.btnCancel.setGeometry(QtCore.QRect(490, 180, 93, 28))
    ...
    def retranslateUi(self, ImportGeoclinoDialog):
        ...
        self.lblFileName.setText(_translate("ImportGeoclinoDialog", "GeoClino Data File"))
        self.btnImport.setText(_translate("ImportGeoclinoDialog", "Import"))
        self.btnCancel.setText(_translate("ImportGeoclinoDialog", "Cancel"))
        self.lblDestinationLayer.setText(_translate("ImportGeoclinoDialog", "Destination Layer"))
