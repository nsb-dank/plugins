...
ui_edit_attribute_dockwidget.ui \
ui_html_edit_dialog.ui \
ui_import_geoclino_dialog.ui \
ui_settings_dialog.ui
...
edit_attribute_dockwidget.py \
geolib3_util.py \
geolib3.py \
html_edit_dialog.py \
import_geoclino_dialog.py \
settings_dialog.py \
...
ui_html_edit_dialog.py \
ui_import_geoclino_dialog.py \
ui_settings_dialog.py

TRANSLATIONS = i18n/geolib3_en.ts
TRANSLATIONS = i18n/geolib3_ja.ts